  ...
  async function handleUpdatePassword() {
    ...
    if (validatePassword(u_password)) {
      try {
        ...
        if (response.data) {
          appDispatch({ type: "toast", data: "Password updated." })
      ...
      appDispatch({ type: "toast", data: "Password not updated due to unmet requirements" })
  ...
  async function handleUpdateEmail() {
    ...
    if (validator.isEmail(u_email)) {
      try {
        ...
        if (response.data) {
          appDispatch({ type: "toast", data: "Email updated." })
      ...
      appDispatch({ type: "toast", data: "Email not updated due to unmet requirements." })
